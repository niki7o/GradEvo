...
PPO_TUNED_HYPERPARAMS: Dict[str, object] = {'policy_kwargs': {'net_arch': [64, 64]}, 'verbose': 0, 'n_steps': 1024, 'batch_size': 64, 'gae_lambda': 0.98, 'gamma': 0.999, 'n_epochs': 4, 'ent_coef': 0.01}
PPO_TUNED_MODELS_DIR: Path = MODELS_DIR / 'ppo_tuned'
